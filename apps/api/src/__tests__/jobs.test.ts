...
describe("jobs API", () => {
  ...
  it("lists the 4 registered jobs for an admin", async () => {
    ...
    expect(keys).toEqual(["batch-status-sweep", "class-reminder-sweep", "gov-source-scrape-sweep", "overdue-installment-sweep"]);
  });
