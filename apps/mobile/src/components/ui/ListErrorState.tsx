...
const s = StyleSheet.create({
  ...
  btn:   { flexDirection: "row", alignItems: "center", gap: ms(6), backgroundColor: "#8B1E3F", borderRadius: ms(12), paddingHorizontal: ms(20), paddingVertical: ms(10), marginTop: ms(8) },
