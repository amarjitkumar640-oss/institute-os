...
const makeStyles = (colors: ThemeColors) => ({
  ...
  primaryBtnDisabled: { backgroundColor: "#C4B3B7" },
  outlineBtn:    { paddingVertical: ms(14), borderRadius: ms(14), borderWidth: 1.5, borderColor: colors.primary, justifyContent: "center" as const, alignItems: "center" as const, backgroundColor: "#FFFFFF" },
  dangerBtn:     { paddingVertical: ms(14), borderRadius: ms(14), backgroundColor: "#C0392B", justifyContent: "center" as const, alignItems: "center" as const },
  ...
  solidT:        { fontSize: fs(15), fontWeight: "700" as const, color: "#fff", includeFontPadding: false },
  outlineT:      { fontSize: fs(15), fontWeight: "700" as const, color: colors.primary, includeFontPadding: false },
});
...
export function PrimaryButton({
  ...
  return (
    <TouchableOpacity
      ...
      disabled={isDisabled}
      activeOpacity={0.82}
      style={[s.primaryBtn, isDisabled && s.primaryBtnDisabled]}
    >
      {loading ? (
        <ActivityIndicator size="small" color="#fff" />
      ) : (
